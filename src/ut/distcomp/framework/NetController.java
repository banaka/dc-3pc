 ...
 */
/**
 * The sendMsg method has been modified by Navid Yaghmazadeh to fix a bug
 * regarding to send a message to a reconnected socket.
 */
...
//                config.procNum, proc));
     ...
     * created yet. Will fail if recipient has not set up their own
     * NetController (and its associated serverSocket)
     *
